...
const About = () => {
  ...
  return (
    <div className='about spacing-h-sm'>
      <div className='container about__intro text-center' style={{ backgroundColor: '#132f4c', padding: '1.5rem', borderRadius: '8px', marginBottom: '2rem', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div className='about__wrapper container'>
        ...
        <Row gutter={[24, 32]} {...({} as ExtendedRowProps)}>
          <Col lg={4} sm={8} xs={12} {...({} as ExtendedColProps)}>
            <div className='column text-center about__member-item' style={{ backgroundColor: '#132f4c', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
              <div className='card'>
                <img
                  src={dhairyaPhoto}
                  alt='Dhairya Sibal'
                ...
                />
                <div className='container about__member-desc' style={{ padding: '0.6rem' }}>
                  <h2 className='mb-1 about__member-name' style={{ color: '#78aafa', fontSize: '1.2rem' }}>Dhairya Sibal</h2>
                </div>
              </div>
            </div>
          </Col>
          <Col lg={4} sm={8} xs={12} {...({} as ExtendedColProps)}>
            <div className='column text-center about__member-item' style={{ backgroundColor: '#132f4c', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
              <div className='card'>
                ...
                />
                <div className='container about__member-desc' style={{ padding: '0.6rem' }}>
                  <h2 className='mb-1 about__member-name' style={{ color: '#78aafa', fontSize: '1.2rem' }}>Priyal Mathur</h2>
                </div>
              </div>
            </div>
          </Col>
          <Col lg={4} sm={8} xs={12} {...({} as ExtendedColProps)}>
            <div className='column text-center about__member-item' style={{ backgroundColor: '#132f4c', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
              <div className='card'>
                ...
                />
                <div className='container about__member-desc' style={{ padding: '0.6rem' }}>
                  <h2 className='mb-1 about__member-name' style={{ color: '#78aafa', fontSize: '1.2rem' }}>Suhaan Khurana</h2>
                </div>
              </div>
            </div>
          </Col>
          <Col lg={4} sm={8} xs={12} {...({} as ExtendedColProps)}>
            <div className='column text-center about__member-item' style={{ backgroundColor: '#132f4c', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
              <div className='card'>
                ...
                />
                <div className='container about__member-desc' style={{ padding: '0.6rem' }}>
                  <h2 className='mb-1 about__member-name' style={{ color: '#78aafa', fontSize: '1.2rem' }}>Karan Sachdeva</h2>
                </div>
              </div>
            </div>
          </Col>
          <Col lg={4} sm={8} xs={12} {...({} as ExtendedColProps)}>
            <div className='column text-center about__member-item' style={{ backgroundColor: '#132f4c', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
              <div className='card'>
                ...
                />
                <div className='container about__member-desc' style={{ padding: '0.6rem' }}>
                  <h2 className='mb-1 about__member-name' style={{ color: '#78aafa', fontSize: '1.2rem' }}>Ronit</h2>
                </div>
              </div>
            </div>
          </Col>
          <Col lg={4} sm={8} xs={12} {...({} as ExtendedColProps)}>
            <div className='column text-center about__member-item' style={{ backgroundColor: '#132f4c', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
              <div className='card'>
                ...
                />
                <div className='container about__member-desc' style={{ padding: '0.6rem' }}>
                  <h2 className='mb-1 about__member-name' style={{ color: '#78aafa', fontSize: '1.2rem' }}>Abhijay</h2>
                </div>
              </div>
            </div>
          </Col>
